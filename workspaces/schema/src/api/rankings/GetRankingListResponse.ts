...
export const RankingModel = createSelectSchema(ranking)
  .pick({
    id: true,
    rank: true,
  })
...
export const GetRankingListResponseSchema = RankingModel.array();

export type Ranking = z.infer<typeof RankingModel>;
